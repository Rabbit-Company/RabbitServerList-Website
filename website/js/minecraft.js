...
function renderServers(servers){
	...
	for(let i = 0; i < servers.length; i++){
		...
		data += "<td class='text-center px-4 py-4 whitespace-nowrap text-sm text-gray-500'><img class='rounded-t-md w-full' src='https://api.rabbitserverlist.com/v1/server/minecraft/" + servers[i].id + "/banner' /><span class='w-full inline-flex items-center px-2.5 py-0.5 text-sm rounded-b-md font-medium " + online_color + "'><a href='#'>" + servers[i].ip + "</a></span></td>";
